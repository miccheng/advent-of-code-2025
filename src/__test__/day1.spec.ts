...
describe('Day1 Tests', () => {
    ...
    test('Multiple movements', () => {
        expect(solution("L68\nL30")).include({ dialPosition: 52, password: 0, '0x434C49434B': 1 });
        expect(solution("L68\nL30\nR48")).include({ dialPosition: 0, password: 1, '0x434C49434B': 2 });
        expect(solution("L68\nL30\nR48\nL5\nR60\nL55\nL1\nL99\nR14\nL82")).include({ dialPosition: 32, password: 3, '0x434C49434B': 6 });
